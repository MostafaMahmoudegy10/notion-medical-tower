          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-gray-600 mb-6 text-lg">
                Founded in 2010, Notion Medical began as a small clinic with a
                big vision: to transform healthcare delivery through innovative
                approaches and patient-centered care.
              </p>
              <p className="text-gray-600 mb-6 text-lg">
                Today, we've grown into a leading medical facility serving
                thousands of patients annually, while maintaining our commitment
                to personalized, high-quality care.
              </p>
              <p className="text-gray-600 text-lg">
                Our journey has been guided by core values of integrity,
                excellence, and compassion - principles that continue to shape
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-blue-50 p-6 rounded-xl">
                ...
                <p className="text-gray-600">
                  Board-certified physicians across specialties
                </p>
              </div>
              <div className="bg-blue-50 p-6 rounded-xl">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-600">
                    Modern examination rooms equipped with latest technology
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
                  ...
                  <span className="text-gray-600">
                    On-site diagnostic imaging center
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
                  ...
                  <span className="text-gray-600">
                    Comfortable patient recovery areas
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
                  ...
                  <span className="text-gray-600">
                    Fully accredited surgical suites
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Schedule your appointment today and join thousands of satisfied
            patients who trust Notion Medical.
          </p>
          <Link to={"/contact"}>
